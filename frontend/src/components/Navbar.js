            ...
            <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0">
              ...
              <li>
                <Link
                  to="/schedule"
                  className={`block py-2 px-3 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-yellow-300 md:p-0 ${
                    location.pathname === '/schedule' ? 'text-yellow-300' : ''
                  }`}
                >
                  Schedule
                </Link>
              ...
              <li>
                <Link
                  to="/resources"
                  className={`block py-2 px-3 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-yellow-300 md:p-0 ${
                    location.pathname === '/resources' ? 'text-yellow-300' : ''
                  }`}
                >
                  Resources
                </Link>
              ...
              <li>
                <Link
                  to="/centers"
                  className={`block py-2 px-3 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-yellow-300 md:p-0 ${
                    location.pathname === '/centers' ? 'text-yellow-300' : ''
                  }`}
                >
                  Our Centers
                </Link>
              ...
              <li>
                <Link
                  to="/clearence"
                  className={`block py-2 px-3 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-yellow-300 md:p-0 ${
                    location.pathname === '/clearence' ? 'text-yellow-300' : ''
                  }`}
                >
                  Clearence
                </Link>
              ...
              <li>
                <Link
                  to="/contact"
                  className={`block py-2 px-3 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-yellow-300 md:p-0 ${
                    location.pathname === '/contact' ? 'text-yellow-300' : ''
                  }`}
                >
                  Contact
                </Link>
