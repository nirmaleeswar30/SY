        ...
        <div className="pt-10 pb-14">
          ...
          >
            ...
            >
              ...
              <p className="text-lg text-gray-600">Find a meditation center near you</p>
            </motion.div>
              ...
              >
                <thead>
                  <tr className="bg-gradient-to-r from-red-800 to-red-700">
                    <th className="p-4 text-left text-white font-bold"><MapPin className="inline-block mr-2" size={16} />Location</th>
                    <th className="p-4 text-left text-white font-bold"><Clock className="inline-block mr-2" size={16} />Time</th>
                    <th className="p-4 text-left text-white font-bold"><User className="inline-block mr-2" size={16} />Contact Person</th>
                    <th className="p-4 text-left text-white font-bold"><Phone className="inline-block mr-2" size={16} />Phone Number</th>
                  </tr>
                </thead>
                <tbody>
                  <AnimatePresence>
                    {filteredData.map((row, index) => (
                      <motion.tr 
                        ...
                        transition={{ duration: 0.2 }}
                      >
                        <td className="p-4 text-gray-800 border-b">{row.city}</td>
                        <td className="p-4 text-gray-800 border-b">{row.time}</td>
                        <td className="p-4 text-gray-800 border-b">{row.contactPerson}</td>
