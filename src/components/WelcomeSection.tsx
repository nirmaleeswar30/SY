    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center justify-between">
          <motion.div style={{ scale }} className="lg:w-1/2 mb-10 lg:mb-0 z-10">
            <FadeInWhenVisible>
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      <div>
                        <p className="font-medium">{t('welcome.sessions.morning.title')}</p>
                    ...
                    >
                      <div>
                        <p className="font-medium">{t('welcome.sessions.beginner.title')}</p>
                        <p className="text-gray-600">{t('welcome.sessions.beginner.time')}</p>
                      </div>
                      <motion.button
                        className="bg-primary text-white px-6 py-2 rounded-full hover:bg-primary-dark transition"
                        whileHover={{ scale: 1.05 }}
