...
const HumanSubtleSystem: React.FC = () => {
  ...
  return (
    <div className="bg-orange-100">
      <section className="max-w-6xl mx-auto px-4 lg:px-0 py-12">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-medium text-red-600 mb-2">
            The Human Subtle System
          </h1>
          <h2 className="text-lg md:text-xl font-normal text-red-500">
            Ancient Knowledge of our Roots - Chakras Qualities
          </h2>
        </motion.div>

        <div className="sm:mt-16  flex flex-col lg:flex-row items-center justify-center lg:space-x-8 space-y-6 lg:space-y-0">
          <motion.div
          ...
          <motion.div
            className="w-full lg:w-1/2 text-gray-700 leading-relaxed text-justify"
            variants={fadeInUp}
            initial="hidden"
            animate="visible"
          >
        ...
        <motion.div
          ...
          initial="hidden"
          animate={controls}
          className="w-full text-gray-700 leading-relaxed text-md text-justify mt-8"
        >
          ...
          {chakrasData.map((chakra, index) => (
            ...
            >
              ...
              <p className="mb-4">{chakra.content}</p>
            </motion.div>
          ))}
        </motion.div>
      </section>
