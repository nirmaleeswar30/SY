  ...
  return (
    ...
    >
      <div className="relative aspect-[3/4]">
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="inline-flex items-center px-6 py-3 bg-white text-maroon-700 rounded-lg 
                     hover:bg-maroon-50 transition-colors shadow-xl"
          >
      ...
      <div className="p-6">
        ...
        <p className="text-maroon-600 mb-2">{book.author}</p>
